...
namespace AccessHistoryService.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class EventHistoryControllerV1 : ControllerBase
    {
        private readonly DbProvider _provider;

        private readonly ILogger<EventHistoryControllerV1> _logger;

        public EventHistoryControllerV1(ILogger<EventHistoryControllerV1> logger,
            DbProvider provider)
        {
            _logger = logger;
            _provider = provider;
